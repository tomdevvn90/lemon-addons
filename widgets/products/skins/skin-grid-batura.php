		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-product__star-rating' => 'justify-content: {{VALUE}};',
				],
			]
		);
	...
	public function register_design_content_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
          '{{WRAPPER}} .elementor-product .button .icon' => 'fill: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-product__content .elementor-product__info h3.elementor-product__title' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_batura_show_title!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					' {{WRAPPER}} .elementor-product__content .elementor-product__info h3.elementor-product__title a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_batura_show_title!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-product__content .elementor-product__info h3.elementor-product__title',
				'condition' => [
					'skin_grid_batura_show_title!' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-product__content .elementor-product__info span.elementor-product__price' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_batura_show_price!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					' {{WRAPPER}} .elementor-product__content .elementor-product__info span.elementor-product__price del' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_batura_show_price!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-product__content .elementor-product__info span.elementor-product__price',
				'condition' => [
					'skin_grid_batura_show_price!' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_batura_show_star_rating!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_batura_show_category!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-product__content .elementor-product__info .elementor-product__category a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_batura_show_category!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					' {{WRAPPER}} .elementor-product__content .elementor-product__info .elementor-product__category a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_batura_show_category!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-product__content .elementor-product__info .elementor-product__category a',
				'condition' => [
					'skin_grid_batura_show_category!' => '',
				],
			]
		...
		<article id="post-<?php the_ID();  ?>" <?php post_class( $product_class ); ?>>
			<a href="<?php echo get_the_permalink(); ?>">
				<?php if( '' !== $this->parent->get_instance_value_skin('show_thumbnail') ) { ?>
					<div class="elementor-product__item">
	          ...
	          <div class="elementor-product__content">
	            <div class="elementor-product__info">
	            <?php
