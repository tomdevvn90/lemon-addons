...
class Skin_Grid_Pumori extends Skin_Base {
	...
	public function get_title() {
		return __( 'List Pumori', 'lemon-addons' );
	}
	...
	public function register_design_content_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-product__content h3.elementor-product__title' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_pumori_show_title!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					' {{WRAPPER}} .elementor-product__content h3.elementor-product__title a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_pumori_show_title!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-product__content h3.elementor-product__title',
				'condition' => [
					'skin_grid_pumori_show_title!' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_pumori_show_star_rating!' => '',
				],
			]
		);
