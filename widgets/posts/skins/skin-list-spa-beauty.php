...
class Skin_List_Spa_Beauty extends Skin_Base {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-post__content::after' => 'padding-bottom: calc( ({{SIZE}} * 100%) + 50px );',
				],
				'condition' => [
					'skin_list_spa_beauty_show_thumbnail!'=> '',
				],
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__meta li' => 'background: {{VALUE}};',
				],
				'condition' => [
					'skin_list_spa_beauty_show_meta!' => '',
				],
