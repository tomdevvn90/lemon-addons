...
class Skin_Cosmetics extends Skin_Base {
	...
	public function get_title() {
		return __( 'Cobble Cosmetics', 'lemon-addons' );
	}
    ...
    $this->start_controls_section(
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__meta a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_cosmetics_show_meta!' => '',
				],
        ...
        <article id="post-<?php the_ID();  ?>" <?php post_class( $post_classes ); ?>>
            <?php if( '' !== $this->parent->get_instance_value_skin('show_thumbnail') ) { ?>
                <div class="elementor-post__thumbnail">
                    ...
                    <a class="elementor-post__readmore" href="<?php echo get_the_permalink( ); ?>" titile="Read More">
                        <span>
            ...
            <div class="elementor-post__content">
                ...
                <ul class="elementor-post__meta">
                    ...
                    <li>
                        <?php
                        echo '<span>' . esc_html__('By ', 'lemon-addons') . '</span>' .
                        '<a class="author" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">'.
                            get_the_author() .
                        '</a>';
                        ?>
                    </li>
