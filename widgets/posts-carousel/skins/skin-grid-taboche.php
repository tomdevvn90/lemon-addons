...
class Skin_Grid_Taboche extends Skin_Base {
	...
	public function get_title() {
		return __( 'Grid Taboche', 'lemon-addons' );
	}
        ...
        <div class="elementor-post__content">
					<?php if( '' !== $this->parent->get_instance_value_skin('show_author') ) { ?>
						<div class="elementor-post__author">
							<?php
							echo '<a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '"><span>' . esc_html__('By ', 'lemon-addons') . '</span>' . get_the_author() .
							'</a>';
							?>
						</div>
					<?php } ?>
