...
class Skin_Grid_Beauty extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-beauty';
	}


	public function get_title() {
		return __( 'Grid Beauty', 'bearsthemes-addons' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_beauty_show_thumbnail!'=> '',
				],
			]
		);
    ...
    public function register_design_content_section_controls( Widget_Base $widget ) {
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'meta_primary_typography',
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-post__meta .meta-date',
				'condition' => [
					'skin_grid_beauty_show_meta!' => '',
				],
			]
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__meta .meta-author a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-post__meta .meta-author a svg' => 'fill: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_beauty_show_meta!' => '',
				],
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'meta_secondary_typography',
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-post__meta .meta-author',
				'condition' => [
					'skin_grid_beauty_show_meta!' => '',
				],
			]
            ...
            <article id="post-<?php the_ID();  ?>" <?php post_class( 'elementor-post' ); ?> >
                ...
                <?php if( '' !== $this->parent->get_instance_value_skin('show_meta') ) { ?>
                    <ul class="elementor-post__meta">
                        <li class="meta-date">
                            <?php
                                echo '<time class="entry-date published" datetime="' . esc_attr( get_the_date( DATE_W3C ) ) . '"><span>' . esc_html( get_the_date('j') ) . '</span>'. esc_html( get_the_date('M Y') ) .'</time>';
                            ?>
                        </li>
