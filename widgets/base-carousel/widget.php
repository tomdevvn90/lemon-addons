...
class Be_Base_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Be Base Carousel', 'lemon-addons' );
	}
			...
			[
				...
				'default' => [
					[
						...
						'list_title' => __( 'This is the heading #1', 'lemon-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #2', 'lemon-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #3', 'lemon-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #4', 'lemon-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #5', 'lemon-addons' ),
						'list_url' => '',
					],
				],
