...
class Be_CountDown extends Widget_Base {
	...
	public function get_title() {
		return __( 'Be Count Down', 'lemon-addons' );
	}
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'rounded' => __( 'Rounded', 'lemon-addons' ),
		...
		$this->add_control(
			'date_end',
			[
				'label' => __( 'Date End', 'lemon-addons' ),
	...
	protected function register_design_layout_section_controls() {
		...
		$this->add_responsive_control(
			'section_size',
			[
				'label' => __( 'Section Size', 'lemon-addons' ),
		...
		$this->add_control(
			'section_bg_color',
			[
				'label' => __( 'Section Background Color', 'lemon-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Section Border Color', 'lemon-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
	...
	protected function register_design_content_section_controls() {
		...
		$this->add_control(
			'separator_color',
			[
				'label' => __( 'Separator Color', 'lemon-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
