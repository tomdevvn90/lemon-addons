<?php
namespace BearsthemesAddons\Widgets\Products_Masonry;
...
class Be_Products_Masonry extends Widget_Base {
    public function get_name() {
		return 'be-products-masonry';
	}
    ...
    protected function register_layout_section_controls() {
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'selectors' => [
                    '{WRAPPER} .grid-masonry .grid-sizer' => 'width: calc(100% / {{VALUE}})',
                    '{WRAPPER} .grid-masonry .elementor-product' => 'width: calc(100% / {{VALUE}})',
                ],
			]
		);
	...
	protected function register_design_content_section_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .filter-menu span' => 'color: {{VALUE}};',
				],
                'condition' => [
                    'filter_type' => 'default',
                ]
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .filter-menu span:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .filter-menu span.active' => 'color: {{VALUE}};',
				],
                'condition' => [
                    'filter_type' => 'default',
                ]
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .filter-menu span' => 'background-color: {{VALUE}};',
				],
                'condition' => [
                    'filter_type' => 'default',
                ]
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .filter-menu span:hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .filter-menu span.active' => 'background-color: {{VALUE}};',
				],
                'condition' => [
                    'filter_type' => 'default',
                ]
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .filter-menu span' => 'border-color: {{VALUE}};',
				],
                'condition' => [
                    'filter_type' => 'default',
                ]
	...
	protected function register_design_pagination_section_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .elementor-pagination #ajax_load_more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
                'condition' => [
					'pagination' => 'ajax_load_more',
				],
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .elementor-pagination #ajax_load_more' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
                'condition' => [
					'pagination' => 'ajax_load_more',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-pagination #ajax_load_more' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'pagination!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-pagination #ajax_load_more' => 'color: {{VALUE}}',
				],
				'condition' => [
					'pagination!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-pagination #ajax_load_more' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'pagination!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-pagination #ajax_load_more:hover' => 'color: {{VALUE}}',
				],
				'condition' => [
					'pagination!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-pagination #ajax_load_more:hover' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'pagination!' => '',
				],
    ...
    public function query_posts() {
        ...
        $posts_per_page;
        if ('ajax_load_more' === $settings['pagination']) {
            $posts_per_page = -1;
        }  else {
    ...
    public function filter_products_category() {
            ...
            if($settings['filter_type'] == 'default' ) {
                ...
                <div class="default-wrapper">
                    <div class="filter-menu">
                        <span value="*">Show All</span>
                        <?php if( ! empty( $categories )  && ! is_wp_error( $categories ) ) : ?>
                            <?php foreach($categories as $category) : ?>
                                <span value=".product_cat-<?php echo $supported_taxonomies[$category->term_id] = $category->slug ?>"><?php echo $supported_taxonomies[$category->term_id] = $category->name ?></span>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <?php
            } else if($settings['filter_type'] === 'dropdown') {
            ?>
                <div class="dropdown-wrapper">
                    <div class="dropdown">
                        <div class="select filters-select">
                            <span>Show All</span>
                            <i class="fa fa-chevron-left"></i>
                        </div>
                        <input type="hidden" name="gender">
                        <ul class="dropdown-menu">
                            <li value="*">Show All</li>
                            <?php if( ! empty( $categories )  && ! is_wp_error( $categories ) ) : ?>
                                <?php foreach($categories as $category) : ?>
                                    <li value=".product_cat-<?php echo $supported_taxonomies[$category->term_id] = $category->slug ?>"><?php echo $supported_taxonomies[$category->term_id] = $category->name ?></li>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </ul>
                    </div>
    ...
    public function render_loop_header() {
        ...
        ?>
            <div class="<?php echo esc_attr( $classes ); ?> grid-masonry">
    ...
    public function pagination() {
		...
		if ( '' === $settings['pagination'] ) {
			return;
		} elseif ('ajax_load_more' === $settings['pagination']) {
            ...
            <nav class="elementor-pagination">
                <button id="ajax_load_more" data-product-to-show="<?php echo $this->get_settings_for_display('posts_per_page') ?>"><?php echo $settings['load_more_text']; ?></button>
            </nav>
            <?php
        } else {
            ...
            <article id="post-<?php the_ID();  ?>" <?php post_class( 'elementor-product' ); ?>>
                <div class="elementor-product__header">
                    ...
                    <div class="elementor-product__thumbnail">
                        <?php the_post_thumbnail( $settings['thumbnail_size'], 'full' ); ?>
                    </div>
